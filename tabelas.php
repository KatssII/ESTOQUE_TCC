    ...
    if (!isset($_SESSION['popup_exibido'])) {
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
              Swal.fire({
                title: 'Bem-vindo!',
                text: 'Seja bem-vindo ao Tucas, {$_SESSION['login']}! :)',
                imageUrl: 'imagens/tucano.gif',
                imageWidth: 500,
                imageHeight: 300,
                imageAlt: 'Custom image',
                confirmButtonText: 'Fechar',
                customClass: {
                  image: 'rounded-image' // Adiciona a classe CSS para arredondar a imagem
                }
              });
            });
        </script>
...
<html lang="pt-br">
    <head>
        ...
        .logout a {
          ...
          .rounded-image {
            border-radius: 10px;  /*Ajuste o valor para definir o arredondamento desejado da img do popup */
        }
...
<div class="logo">
    ...
    <a href="#" class="logo-link">
            ...
            <div class="sobre-nos">
              <a href="sobreNos.php"><i class="bi bi-chat-left-quote"></i> Sobre o Nós</a>
            </div>
